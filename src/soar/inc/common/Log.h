...
// Some helpful Macros
#define LOG_SPACE               << " "
#define LOG_FATAL               Log::GetInstance()->Message(Log::MessageLevel::FATAL_ERROR) LOG_SPACE
#define LOG_RECOVERABLE         Log::GetInstance()->Message(Log::MessageLevel::RECOVERABLE_ERROR) LOG_SPACE
#define LOG_WARNING             Log::GetInstance()->Message(Log::MessageLevel::WARNING) LOG_SPACE
#define LOG_NOTICE              Log::GetInstance()->Message(Log::MessageLevel::NOTICE) LOG_SPACE
#define LOG_MESSAGE             Log::GetInstance()->Message(Log::MessageLevel::MESSAGE) LOG_SPACE
