...
void Keyboard::populateStringReps()
{
    ...
    stringReps = {
        ...
        { GLFW_KEY_WORLD_1,         { "W #1",                   "Non-US #1" } },
        { GLFW_KEY_WORLD_2,         { "W #2",                   "Non-US #2" } },
        ...
        { GLFW_KEY_RIGHT,           { "Rght",                   "Right Arrow" } },
        { GLFW_KEY_LEFT,            { "Left",                   "Left Arrow" } },
        { GLFW_KEY_DOWN,            { "Dn",                     "Down Arrow" } },
        ...
        { GLFW_KEY_CAPS_LOCK,       { "Cps",                    "Caps Lock" } },
        { GLFW_KEY_SCROLL_LOCK,     { "Scr",                    "Scroll Lock" } },
        { GLFW_KEY_NUM_LOCK,        { "Num",                    "Num Lock" } },
        ...
        { GLFW_KEY_KP_0,            { "NP 0",                   "Number Pad 0" } },
        { GLFW_KEY_KP_1,            { "NP 1",                   "Number Pad 1" } },
        { GLFW_KEY_KP_2,            { "NP 2",                   "Number Pad 2" } },
        { GLFW_KEY_KP_3,            { "NP 3",                   "Number Pad 3" } },
        { GLFW_KEY_KP_4,            { "NP 4",                   "Number Pad 4" } },
        { GLFW_KEY_KP_5,            { "NP 5",                   "Number Pad 5" } },
        { GLFW_KEY_KP_6,            { "NP 6",                   "Number Pad 6" } },
        { GLFW_KEY_KP_7,            { "NP 7",                   "Number Pad 7" } },
        { GLFW_KEY_KP_8,            { "NP 8",                   "Number Pad 8" } },
        { GLFW_KEY_KP_9,            { "NP 9",                   "Number Pad 9" } },
        { GLFW_KEY_KP_DECIMAL,      { "NP .",                   "Number Pad Decimal" } },
        { GLFW_KEY_KP_DIVIDE,       { "NP /",                   "Number Pad Divide" } },
        { GLFW_KEY_KP_MULTIPLY,     { "NP *",                   "Number Pad Multiply" } },
        { GLFW_KEY_KP_SUBTRACT,     { "NP -",                   "Number Pad Subtract" } },
        { GLFW_KEY_KP_ADD,          { "NP +",                   "Number Pad Add" } },
        { GLFW_KEY_KP_ENTER,        { "NP Ret",                 "Number Pad Enter" } },
        { GLFW_KEY_KP_EQUAL,        { "NP =",                   "Number Pad Equal" } },
